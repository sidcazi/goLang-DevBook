...
// Altera os dados de uma unica publicação
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	parametros := mux.Vars(r)
	publicacaoID, erro := strconv.ParseUint(parametros["publpicacaoID"], 10, 64)
...
// BucarPublicasoe é uma funcção que busca a publicação do usuario
...
// Descurtir publicação subtrai uma curtida na publicação
