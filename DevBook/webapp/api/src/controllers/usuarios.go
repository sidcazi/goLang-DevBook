...
// CriarUsuario Insere Usuário no Banco
...
func BuscarUsuarios(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, error)
		return
	}
...
// Buscar usuario Busca apenas um usuário pelo ID
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("Não é possivel deletar um usuario que não seja o seu"))
		return
	}
...
// Buscar seguidores tras todos os seguidores de um usuário
...
// Busca os usuarios que o id logado está seguindos
...
// Atualizar a senha permite alterar a senha de um determinado usuário
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("Não é possivel atualizar senha que não seja sua"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A Senha atual não é a que está slava no banco"))
		return
	}
